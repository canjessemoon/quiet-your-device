      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-stone mb-8 leading-relaxed">
            Research shows that this "variable ratio reinforcement" schedule is the most powerful way to shape behavior.<sup>1</sup>
          </p>
          ...
          <div className="space-y-4 mb-8">
            ...
            <div>
              <strong className="text-fern">Sleep Disruption:</strong> <span className="text-stone">The endless "just one more video" cycle pushes bedtimes later.</span>
            </div>
            <div>
