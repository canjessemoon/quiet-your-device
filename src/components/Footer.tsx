    ...
    <footer className="bg-sage text-stone">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Logo and Mission */}
          <div className="col-span-1 md:col-span-2">            <Link href="/" className="flex items-center space-x-2 mb-4">              <Image 
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold mb-4 text-fern">Quick Links</h3>
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/contact" className="hover:text-fern transition-colors">Contact</Link></li>
            </ul>
          </div>
          
          {/* Legal */}
          <div>
            <h3 className="font-semibold mb-4 text-fern">Legal</h3>
            <ul className="space-y-2 text-sm">
              <li><Link href="/privacy" className="hover:text-fern transition-colors">Privacy Policy</Link></li>
              <li><Link href="/terms" className="hover:text-fern transition-colors">Terms of Use</Link></li>
            </ul>
          </div>
        </div>
        
        {/* Bottom Bar */}
        <div className="border-t border-stone/20 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm">
            © 2025 QYD • Quiet Your Device. All rights reserved.
          </p>
          <div className="flex space-x-4 mt-4 sm:mt-0">
            <a href="#" className="text-stone hover:text-fern transition-colors">
